...
export default function Privacy() {
  return (
    <Layout
      title="Katharina Clasen | Privacy"
      ...
      <div className="about-container">
        <div className="text padding-main-left imprint">
          ...
          <p>
            {" "}
            Katharina Clasen
            <br /> Information Lovers
            <br /> Richard- Hirschmann-Str. 14/2
            <br /> 73728 Esslingen
          </p>{" "}
          <p>
            Telephone: +49 176 44484593
            <br /> Email: info@informationlovers.com
          </p>{" "}
          <p>
          ...
          <p>
            ...
            These cookies make it possible to recognize your browser when you
            next visit the site.
          </p>{" "}
          <p>
