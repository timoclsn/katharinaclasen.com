...
const tagVariants = cva({
  base: "font-sans font-medium inline-flex items-center justify-center",
  variants: {
    outline: {
...
const prependVariants = cva({
  base: "font-serif font-normal rounded-full flex items-center justify-center text-contrast-primary-dark [&_img]:w-auto leading-none",
  variants: {
    color: {
