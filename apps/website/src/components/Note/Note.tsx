...
const variants = cva({
  base: "not-prose bg-background-secondary bg-[linear-gradient(transparent_calc(100%-1px),#CBCAC7)] bg-size-[1px_32px] px-6 py-8 sm:bg-size-[1px_40px] sm:py-10 sm:px-8 my-10",
  variants: {
    pull: {
