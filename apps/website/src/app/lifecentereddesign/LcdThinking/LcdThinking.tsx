      ...
      >
        <div className="p-6 sm:p-16">
          ...
          <div className="prose max-w-none leading-6">
            <p>
              This is how I view it: Life-centered Design basically expands our
              thinking and doing in design along two axes:
            </p>
            <ol>
              <li>
                ...
                create something new or where the solution or parts of it
