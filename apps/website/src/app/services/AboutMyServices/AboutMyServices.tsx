      ...
      <div className="flex flex-col gap-12 lg:flex-row">
        <div className="flex-1 pb-24">
          ...
          <Body as="p" priority="secondary">
            ...
            Design. Starting from UX Research – either to discover new insights
            or to test and later optimize solutions – all the way to UI Design,
            including the creation of Design Systems. My clients get almost all
            the skills and knowledge they need for improving or developing new
            digital experiences from one source.
            <br />
            <br />
            ...
            whole digital project and transfer knowledge from one part (e.g. the
            UX Research) to another (e.g. UX Design or UI Design). This is
            especially important in the often rather complex projects I am
            working on, because information can quickly get lost or it would at
            least be really time consuming to make sure that everybody is always
            on the same page.
            <br />
            <br />
            My clients also enjoy the high amoint of flexibility I bring to the
            table, as I can be added to their team only when they need my
            ...
            is of high quality and developers enjoy working with me as I am open
            to their feedback.
          </Body>
        </div>
